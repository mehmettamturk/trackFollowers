(function() {
    trackFollowersApp.controller('MostCommentsController', function($rootScope, $scope, API, $window, $ionicActionSheet, inAppPurchase) {
        ...
        API
            .query({id:'most-comments', access_token: currentUser.access_token}).$promise
